    ...
    languages: {
      en: {
        consent_modal: {
          ...
          description:
            'We use cookies to ensure that we give you the best experience on our website. <button type="button" data-cc="c-settings" class="cc-link">Cookies setting</button>',
          primary_btn: {
            text: "Accept all",
          ...
          blocks: [
            {
              title: "Cookie usage 🍪",
              description:
                'We use cookies to ensure the basic functionalities of the website and to enhance your online experience. You can choose for each category to opt-in/out whenever you want. For more details relative to cookies and other sensitive data, please read the full <a href="https://qohei.com/privacy-policy' +
               ppurl +
            ...
            },
            {
              ...
              description:
                'For any queries in relation to our policy on cookies and your choices, please <a class="cc-link" href="https://qohei.com/contact' +
                contacturl +
                '">contact us</a>.',
            },
          ],
